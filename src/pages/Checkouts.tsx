...
import { Plus, ArrowLeft, Pencil, Trash2, ExternalLink, Settings, Gift } from "lucide-react";
                ...
                <TableBody>
                  {checkouts.map((checkout) => (
                    <TableRow key={checkout.id}>
                      ...
                      <TableCell>{checkout.products?.name || "Produto não encontrado"}</TableCell>
                      ...
                      <TableCell className="text-right">
                        <div className="flex gap-2 justify-end">
                          <Button
                            ...
                            size="icon"
                            title="Order Bumps"
                            onClick={() => navigate(`/checkouts/${checkout.id}/bumps`)}
                          >
